...
#### Saves the total XP you earn from ribbons to local storage. Currently missing XP values for 8 ribbons.
#### Please report any missing XP values in my Ribbon XP thread: http://bit.ly/2nmtxro

| Display Name              	| XP  	| Description                                                                                           	|
|---------------------------	|-----	|-------------------------------------------------------------------------------------------------------	|
| 10-56 In Progress         	| 100  	| Did damage to an enemy that killed themselves in a Versus match.                                      	|
...
| Big Ol' Hero              	| 100  	| Won a Dodgeball match where you were the last man standing.                                           	|
| Big Poppa                 	| 25  	| Killed an enemy with one shot in an Execution or Warzone match.                                       	|
| Boombardier               	| 50  	| Killed multiple enemies with a single explosive shot in Versus or Horde.                              	|
| Bravado                   	| 25  	| Won in sudden death as the last man standing in a Guardian match.                                     	|
| Brotherhood In Battle     	| 50  	| Respawned with at least three teammates in respawn wave in Team Deathmatch.                           	|
| Carmine's Star            	| 100  	| Had the most headshot deaths in a Versus match.                                                       	|
...
| Close Shave               	| 125  	| Won a Team Deathmatch round by 1.                                                                     	|
| Clusterluck               	| 100 	| Killed multiple enemies with a single Frag Grenade in Versus or Horde.                                	|
| Clutch                    	| 25  	| Killed at least three enemies, as the last man out, to win a Versus round.                            	|
| Complete Resurrection     	| 100  	| Was on a team that went from one living player back to five living players in a Dodgeball match.      	|
| Construction Worker       	| 20  	| Upgraded the Fabricator.                                                                              	|
| Contender                 	| 75  	| Had the most melee hits in Versus or Horde.                                                           	|
| Coup de Grâce             	| 50  	| Got the final kill with an execution in Versus or Horde.                                              	|
| Dead Ringer               	| 100  	| Won by shutting out the enemy team in King of the Hill or Escalation.                                 	|
| Dead Weight               	| 50  	| Was brought back twice in a Dodgeball round.                                                          	|
| Death From Below          	| 75  	| Killed an enemy with a grenade while you were down but not out in a Versus match.                     	|
...
| Downtime                  	| 75  	| Died within the first 15 seconds of an Execution or Warzone match.                                    	|
| Duelist                   	| 75  	| Killed an enemy while both of you were in the same ring in King of the Hill or Escalation.            	|
...
| First to Fight            	| 150  	| Got the first kill in every round of a Versus match.                                                  	|
| First!                    	| 125 	| Got the first kill in Versus or Horde.                                                                	|
| Fish in a Barrel          	| 100  	| Killed 3 enemies holding a ring in King of the Hill or Escalation.                                    	|
| Getting It Done           	| 75  	| Killed the leader, as the leader, in a Guardian match.                                                	|
| Gladiator                 	| 75  	| Killed an enemy using the knife execution in an Execution or Warzone match.                           	|
...
| Hair Trigger              	| 75  	| Killed an enemy within 1 second of receiving a new gun in Arms Race.                                  	|
| Happy Ending              	| 75  	| Killed an enemy with the final weapon in an Arms Race match.                                          	|
...
| Hunter                    	| 75  	| Killed every enemy once in Team Deathmatch.                                                           	|
| I Gotcha                  	| 25  	| Revived all four of your teammates in a single wave.                                                  	|
| I Know Kung-Fu            	| 75  	| Countered a close cover combat move.                                                                  	|
| Igor                      	| 50  	| Got 10 assists in a single Versus round.                                                              	|
| I'm Fine                  	| 50  	| Self-revived twice during a Versus match.                                                             	|
| Industrious               	| 100  	| Used more than one Deebee weapon to kill a single enemy.                                              	|
| Inside Out                	| 150  	| Killed an enemy with a Dropshot headshot in a Versus match.                                           	|
| Killjoy                   	| 100  	| Killed an enemy who had a kill streak of 5 or more in a Versus match.                                 	|
| King Slayer               	| 50  	| Killed an enemy holding a ring in King of the Hill or Escalation.                                     	|
| Last Hope                 	| 150 	| Completed a wave as the only player alive.                                                            	|
| Last Man Out              	| 100  	| Was the only surviving member of your team in a Versus mode without respawns.                         	|
| Last Resort               	| --  	| Broke a ring when the enemy team needed 5 or less points to win in King of the Hill.                  	|
| Lead By Example           	| 75  	| Killed five enemies as the leader in a Guardian round.                                                	|
| Leave It All On The Field 	| 50  	| Entered the final possible round with a tie score in an Escalation match.                             	|
| Like a Boss               	| 150 	| Completed a boss wave while not dead nor DBNO.                                                        	|
| Lock and Load             	| 25  	| Placed a weapon in an Escalation match.                                                               	|
...
| Master of the Zone        	| 50  	| Was the last man standing on your team in a round and won the round in an Execution or Warzone match. 	|
...
| My House                  	| 100  	| Was on a team that won 7 straight rounds in an Escalation match.                                      	|
| Negotiations Over         	| 75  	| Headshot an enemy who was holding a meatshield in a Versus match.                                     	|
| Nemesis                   	| 75  	| Killed the same enemy 5 times in a Versus match.                                                      	|
| Never Had A Chance        	| 100  	| Won every round of a Versus match.                                                                    	|
| Never Surrender           	| 75  	| Came from defeat to win a Versus match.                                                               	|
| Nice Pick                 	| 50  	| Killed an enemy with a weapon selected by the enemy team in that round of an Escalation match.        	|
| No Ransom                 	| 50  	| Meatshielded a leader in a Guardian match.                                                            	|
| No Respect                	| 50  	| Killed the top player in a Versus match.                                                              	|
| No Smoking                	| 100 	| Killed an enemy with a Smoke Grenade in Versus or Horde.                                              	|
| No, Wait!                 	| 75  	| Killed an enemy who was reloading in Versus.                                                          	|
...
| Oscar Mike                	| 25  	| Headshot a roadie running enemy.                                                                      	|
| Our House                 	| 50  	| Killed an opponent who was breaking your ring in King of the Hill or Escalation.                      	|
| Out From Under            	| 100  	| Broke a domination in Escalation.                                                                     	|
| Pacifist                  	| --  	| Had more revives than kills in a Versus match.                                                        	|
| Phat Loot                 	| 100 	| Completed a bonus objective.                                                                          	|
| Pioneer                   	| 50  	| Earned the first ring point in King of the Hill.                                                      	|
...
| Sacrifice                 	| 75  	| Broke a ring by yourself while downed in King of the Hill.                                            	|
| Sapper Star               	| 100  	| Killed an enemy by detonating their own planted grenade in a Versus match.                            	|
...
| The Cleaner               	| 100  	| Got the final kill in every round of a Versus match.                                                  	|
...
| Three and Out             	| 75  	| Won an Escalation round by capturing three rings.                                                     	|
...
| Unlucky Bastard           	| 25  	| Was the only person on your team who died in a Versus round.                                          	|
| Valiant                   	| 25  	| Revived the leader the most times in a Guardian match.                                                	|
| Vigilant                  	| 100  	| Won a Versus match with at least 10 kills without dying.                                              	|
| Well Protected            	| 75  	| Was most revived member on your team in Versus or Horde.                                              	|
| You're Welcome!           	| 100  	| Brought back two players in a Dodgeball round.                                                        	|
