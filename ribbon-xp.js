...
if (window.location.href.includes(gearsStatsUrl)) {
    ...
    ribbonXP.set('BrotherhoodInBattle', 50);   ribbonXP.set('CarminesStar', 100);      ribbonXP.set('ChainLightning', 50);
    ...
    ribbonXP.set('LastResort', 75);            ribbonXP.set('LeadByExample', 75);      ribbonXP.set('LeaveItAllOnTheField', 50);
    ...
    ribbonXP.set('NotToday', 50);              ribbonXP.set('Ole', 100);               ribbonXP.set('RoadieRun', 25);
    ribbonXP.set('OurHouse', 50);              ribbonXP.set('OutFromUnder', 100);      ribbonXP.set('Pacifist', 125);
    ...
    ribbonXP.set('Smorgasbord', 100);          ribbonXP.set('SoClose', 100);           ribbonXP.set('Solid', 50);
    ...
    ribbonXP.set('TopOfTheHill', 100);         ribbonXP.set('HardTarget', 50);         ribbonXP.set('TrickShot', 75);
    ribbonXP.set('ShowedUp', 75);              ribbonXP.set('UnluckyBastard', 25);     ribbonXP.set('Valiant', 25);
